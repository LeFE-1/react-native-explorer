...
public class ReactFragment extends Fragment implements PermissionAwareActivity {
   ...
   *
   * <p>This must be called via a forward from your host AudioPlayActivity
   */
  ...
  /**
   * Helper to forward onKeyUp commands from our host AudioPlayActivity. This allows ReactFragment to handle
