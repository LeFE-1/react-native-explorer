 ...
 * an {@link FragmentActivity} or a {@link android.app.Fragment}.
 */
public class ReactDelegate {
    ...
    if (getReactNativeHost().hasInstance()) {
      if (mActivity instanceof DefaultHardwareBackBtnHandler) {
        ...
        throw new ClassCastException(
            "Host AudioPlayActivity does not implement DefaultHardwareBackBtnHandler");
      }
    }
  }
  ...
  /**
   * Handles delegating the {@link FragmentActivity#onKeyUp(int, KeyEvent)} method to determine whether the
